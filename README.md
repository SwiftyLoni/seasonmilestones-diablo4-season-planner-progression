...
<div align="center">
  <img src="./public/logo.svg" alt="SeasonMilestones — Diablo IV — Progression" width="64" height="64">
  <h1>SeasonMilestones — Diablo IV — Progression</h1>
</div>

An independent project specification for Diablo IV, covering season milestone checklist, build requirement notes, resource shopping sheets.
...
<img src="./public/screenshots/desktop-main.svg" alt="Diablo IV — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Diablo IV — compact concept, not a screenshot" width="250">
<br>
...
- **Season milestone checklist** — planned module; not implemented.
- **Build requirement notes** — planned module; not implemented.
- **Resource shopping sheets** — planned module; not implemented.

The proposed workflow separates season milestone checklist from build requirement notes, with resource shopping sheets retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Season milestone checklist**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="SeasonMilestones — Diablo IV — Progression — specification review workflow">
<br>
...
### Season milestone checklist

Define the input and expected outcome for module 1. Record the Diablo IV version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Build requirement notes

Define the input and expected outcome for module 2. Record the Diablo IV version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Resource shopping sheets

Define the input and expected outcome for module 3. Record the Diablo IV version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Season milestone checklist |
