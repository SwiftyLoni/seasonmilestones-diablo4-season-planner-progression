# Verification plan — Diablo IV

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Season milestone checklist

- [ ] Define a versioned input fixture specifically for season milestone checklist.
...
### 2. Build requirement notes

- [ ] Define a versioned input fixture specifically for build requirement notes.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Resource shopping sheets

- [ ] Define a versioned input fixture specifically for resource shopping sheets.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
